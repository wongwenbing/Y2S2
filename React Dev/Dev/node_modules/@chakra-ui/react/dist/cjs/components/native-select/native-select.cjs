...
const [BasePropsProvider, useBasePropsContext] = createContext.createContext({
...
const NativeSelectRoot = withProvider("div", "root", {
  wrapElement(element, props) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(BasePropsProvider, { value: { disabled, invalid }, children: element });
  }
});
